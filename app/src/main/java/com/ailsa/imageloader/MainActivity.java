...
import com.ailsa.imageloader.adapter.ImageAdapter;
import com.ailsa.imageloader.imageloader.ImageLoader;
import com.ailsa.imageloader.utils.Utils;
...
//    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int screenWidth = Utils.getDisplayMetrics(getApplicationContext()).widthPixels;
        int space = (int)Utils.dpTopx(20f, getApplicationContext());
        imageWidth = (screenWidth - space) / 3;
        imageLoader = new ImageLoader(getApplicationContext());
        mGridView = (GridView) findViewById(R.id.images);
        mAdapter = new ImageAdapter(getApplicationContext(), imageUrl, imageLoader, imageWidth);
